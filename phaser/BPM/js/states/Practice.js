...
Practice.prototype = {
	...
	preload: function() {
		console.log('Practice: preload');

	},
	create: function() {
		console.log('Practice: create');
...
*/
	...
	update: function() {
		...
		&& !game.hasStarted) {
			...
			game.time.events.repeat(Phaser.Timer.SECOND * 4, 1, spawnEnemy, this);
			game.time.events.repeat(Phaser.Timer.SECOND * 7, 1, spawnCollect, this);
